...
forEach(arr, function callback(value) {
	console.log(value);
})
...
function showFirstAndLast(arr){
	...
	arr.forEach(function(val) {
		...
		var newStr = firstLetter + lastLetter;
		newArr.push(newStr);
	});
	return newArr;
}
var arr = ["daris", "luthiela", "daemar", "calinor"];
